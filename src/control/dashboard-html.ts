 ...
 * changed in the move.
 *
 * ⛔ THIS FILE IS ONE TEMPLATE LITERAL. A stray backtick ANYWHERE inside it —
 * including in a comment — closes the string early, and the failure surfaces as
 * a baffling type error hundreds of lines away. Use quotes in comments.
 *
